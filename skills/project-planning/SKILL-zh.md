...
> **关于渐进明确性的说明**：下方的迭代路线图是基于当前理解的**初步建议**。只有当前迭代是详细且确定的，后续迭代将通过以下方式逐步明确：
> - 已完成迭代的复盘与学习
> - 对需求和技术挑战的理解不断深入
> - 对变化优先级或约束的适应性调整
>
> 这体现了敏捷开发的**渐进严谨性**原则——我们保持清晰的方向感，同时接受远期细节本质上是不可预知的现实。
...
- **YAGNI**：不要过度规划遥远的迭代
- **增量式**：只规划足够让下一迭代开始的内容
- **渐进明确**：迭代计划是初步的；只有当前迭代是明确定义的
- **渐进严谨性**：随着每个迭代的经验，远期计划逐步清晰
- **适应性**：根据复盘学习更新计划
- **可追溯**：将Epics链接回初始需求
