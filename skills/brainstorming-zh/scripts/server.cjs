// 头脑风暴伴侣服务器 / Brainstorm Companion Server
// 功能：HTTP 服务 + WebSocket 服务 + 文件监听 + 自动刷新
// Features: HTTP server, WebSocket, file watching, auto-reload
...
// ========== WebSocket 协议 (RFC 6455) / WebSocket Protocol ==========
...
// 服务端口（随机高位端口 49152-65535）
const PORT = process.env.BRAINSTORM_PORT || (49152 + Math.floor(Math.random() * 16383));
// 绑定主机（默认本地，0.0.0.0 允许远程）
